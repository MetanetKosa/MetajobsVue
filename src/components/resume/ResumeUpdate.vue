            ...
            <form  @submit.prevent ="onSave" role="form" >
              ...
              <div class="col-12 mb-4">
                  ...
                  <input class="form-control form-control-lg" type="text"
										id="pr-address" v-model= "resume.resume_technology"
              ...
              <div class="col-12 mb-4">
									...
									<textarea  class="form-control form-control-lg" id="pr-address"
										v-model= "resume.resume_cv" cols="30" rows="10" 
              ...
              <div class="d-md-flex align-items-center mb-4 pb-md-2">
									...
									<div class="ms-md-auto">
										...
										<ul
											...
											<li class="border-end mb-0"><button :disabled = "!todoUpdated"
													id="delete"
...
export default {
  setup(){
    ...
    const onSave = async() => {
      const res = await axios.put(`/users/1/resumes/${resumeId}`,{
        resume_title: resume.value.resume_title,
        resume_gender: resume.value.resume_gender,
        resume_technology: resume.value.resume_technology,
        resume_cv: resume.value.resume_cv,
        resume_career: resume.value.resume_career
      });
     ...
     const todoUpdated = computed(() => {
            return !_.isEqual(resume.value, originalResume.value);
    });
    ...
    return {resume, onSave, todoUpdated}
  }
}
</script>
