                ...
                <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5"><a class="btn btn-outline-info rounded-pill w-100 mb-3" href="#"><i class="fi-google fs-lg me-1"></i>Sign in with Google</a><a class="btn btn-outline-info rounded-pill w-100 mb-3" href="#"><i class="fi-facebook fs-lg me-1"></i>Sign in with Facebook</a>
                    ...
                    <form @submit.prevent="signUp" class="needs-validation" novalidate>
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" v-model="mem_id" required pattern="[A-Za-z0-9]{4,20}" autocomplete="off">
                            
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="signup-password">Password<span class='fs-sm text-muted'>&nbsp;&nbsp;최소 4글자 이상</span></label>
                            <div class="password-toggle">
                                <input class="form-control" type="password" v-model="mem_pw" id="signup-password" minlength="4" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" v-model="mem_name" id="signup-name" pattern="[가-힣]{2,10}" placeholder="이름" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="signup-birth">Birth</label>
                            <div class="input-group input-group-lg">
                            <input class="form-control date-picker rounded pe-5" type="text" id="signup-birth" v-model="mem_birth" placeholder="Choose date" data-datepicker-options="{&quot;altInput&quot;: true, &quot;altFormat&quot;: &quot;F j, Y&quot;, &quot;dateFormat&quot;: &quot;Y-m-d&quot;}"><i class="fi-calendar text-muted position-absolute top-50 end-0 translate-middle-y me-3"></i>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="signup-address">Address</label>
                            <input class="form-control" type="text" v-model="mem_address" id="signup-address" placeholder="주소" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="signup-phone">Phone</label>
                            <input class="form-control" type="text" v-model="mem_phone" id="signup-phone" placeholder="전화번호" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="signup-email">Email</label>
                            <input class="form-control" type="email" v-model="mem_email" id="signup-email" placeholder="@gmail.com" required>
                        </div>
